    ...
    def handle(self, *args, **options):
        ...
        for product_name in ingredients.keys():
            ...
            if not product: 
                errors=True
                continue
            ingredients[product_name]["quantity_real"]=measure.factor*ingredients[product_name]["quantity"]
