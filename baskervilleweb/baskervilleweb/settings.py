...
SECRET_KEY = 'j7^rfic-uw(9$g#el_*s*blai!2ccos##ajr87_ia#5ah)_fq*'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'baskerville-devel',      # Or path to database file if using sqlite3.
        'USER': 'baskerville-devel',      # Not used with sqlite3.
        'PASSWORD': 'baskerville-devel',  # Not used with sqlite3.
